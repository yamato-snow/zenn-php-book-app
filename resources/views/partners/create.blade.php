...
@section('content')
    ...
    <form action="{{ route('partners.store') }}" method="POST" class="bg-white rounded shadow p-4">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name"
                   value="{{ old('name') }}"
                   class="w-full border rounded px-3 py-2" placeholder="例：株式会社サンプル商事">
        </div>
